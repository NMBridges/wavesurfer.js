(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WaveSurfer.Segmentation = factory(root.WaveSurfer);
    }
}(this, function (WaveSurfer) {
    'use strict';

    WaveSurfer.Segmentation = {
        init: function (params) {
            ...
            if (!this.container) {
                throw Error('No container for WaveSurfer segmentation');
            }
        ...
        createWrapper: function () {
            var prevSegmentation = this.container.querySelector('segmentation');
            if (prevSegmentation) {
                this.container.removeChild(prevSegmentation);
            }

            var wsParams = this.wavesurfer.params;
            this.wrapper = this.container.appendChild(
                document.createElement('segmentation')
            );
        ...
        drawSegmentationCanvas: function() {
    ...
    WaveSurfer.util.extend(WaveSurfer.Segmentation, WaveSurfer.Observer);

    return WaveSurfer.Segmentation;
}));
